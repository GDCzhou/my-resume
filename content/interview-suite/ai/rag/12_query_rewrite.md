...
description: "12. 如何润色用户的 Query（Query Rewrite）？目的是什么？ 👔面试官：RAG 系统里为什么要做 Query Rewrite？你了解哪些方法？ 🙋‍♂️我：Query Rewrite 就是把用户的问题改写得更规范嘛，比如把…"
---

# 12. 如何润色用户的 Query（Query Rewrite）？目的是什么？

<div class="qa-dialog">
<p class="qa-q"><strong>面试官</strong>：RAG 系统里为什么要做 Query Rewrite？你了解哪些方法？</p>

<p class="qa-a"><strong>我</strong>：Query Rewrite 就是把用户的问题改写得更规范嘛，比如把口语转成书面语，主要就是为了提升检索效果，其他没什么特别的。</p>

<p class="qa-q"><strong>面试官</strong>：那用户问「这个功能怎么用」，知识库里写的是「XX 模块操作指南」，你光改写成书面语就能命中了？如果改写之后还是对不上呢？</p>

<p class="qa-a"><strong>我</strong>：那就多试几种改写方式呗，总能蒙对的……</p>

<p class="qa-q"><strong>面试官</strong>：蒙？你是说靠运气做检索优化？你有没有听说过 HyDE、Step-back Prompting 这些方法？它们各自解决什么问题你清楚吗？</p>
...
![](/images/cdn.xiaolincoding.com/picgo/1776825805308-db8dd766-72ed-44ef-9699-eedc7d84aa02.png)
...
![](/images/cdn.xiaolincoding.com/picgo/1776825886765-2c5721ea-84f9-4ac5-85d1-e65ee8ffb2dc.png)
...
![](/images/cdn.xiaolincoding.com/picgo/1776825956495-f7d46fc4-72b2-47d5-b580-3a3705518ca4.png)
...
![](/images/cdn.xiaolincoding.com/picgo/1776826053676-5c7605f0-72c7-4e2a-bfaf-45f711f655aa.png)
...
![](/images/cdn.xiaolincoding.com/picgo/1776826169999-dabd9a4f-3d2f-47fb-8526-2281ffcb60e9.png)
