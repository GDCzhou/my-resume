...
description: "16. 在什么场景下，你会选择使用图数据库来增强传统的向量检索？ 👔面试官：在什么场景下，你会选择使用图数据库来增强传统的向量检索？ 🙋‍♂️我：图数据库？我觉得向量检索已经够用了吧，大部分场景都能覆盖，图数据库主要是搞社交网络那种，和 R…"
---

# 16. 在什么场景下，你会选择使用图数据库来增强传统的向量检索？

<div class="qa-dialog">
<p class="qa-q"><strong>面试官</strong>：在什么场景下，你会选择使用图数据库来增强传统的向量检索？</p>

<p class="qa-a"><strong>我</strong>：图数据库？我觉得向量检索已经够用了吧，大部分场景都能覆盖，图数据库主要是搞社交网络那种，和 RAG 关系不大。</p>

<p class="qa-q"><strong>面试官</strong>：向量检索只能做单跳检索，找不到多个实体之间的关联关系。用户问「A 公司的投资方和 B 公司有什么交集」，你用向量检索试试看？</p>

<p class="qa-a"><strong>我</strong>：呃，那我可能会多检索几次，把关键词拆开分别搜，应该也能拼出答案吧？</p>

<p class="qa-q"><strong>面试官</strong>：多检索几次？你连实体之间的边在哪都不知道，怎么跳？图数据库就是专门解决多跳关系推理的，向量检索根本做不到。你对这两种技术的互补关系完全没有理解。</p>
...
![](/images/cdn.xiaolincoding.com/picgo/image-20260305004826415.png)
...
![](/images/cdn.xiaolincoding.com/picgo/1776830952624-ddf9acc2-abca-4e5c-acfb-fa72894ff26b.png)
...
![](/images/cdn.xiaolincoding.com/picgo/image-20260305144215708.png)

有了这张网之后，就可以做「图遍历」：从一个节点出发，沿着关系边一跳一跳地走，把路径上所有相关节点的信息都收集回来。这正好补了向量检索的短板。

![](/images/cdn.xiaolincoding.com/picgo/1776831249625-d579645d-7d81-47f0-a1ce-320bdd0408eb.png)
...
![](/images/cdn.xiaolincoding.com/picgo/1776836753019-e7b6f9ff-971d-4c12-8fd2-d069f9d712ce.png)
...
![](/images/cdn.xiaolincoding.com/picgo/1776833517794-6134ba53-3192-4ac6-acd1-d2b507fc43db.png)
