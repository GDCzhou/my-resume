...
description: "7. Embedding 有哪几种算法你了解过吗？ 👔面试官：RAG 里用的 Embedding 算法有哪些？你了解过几代演进？ 🙋‍♂️我：Embedding 算法我知道，Word2Vec 嘛，把词变成向量。 👔面试官：Word2Vec…"
---

# 7. Embedding 有哪几种算法你了解过吗？

<div class="qa-dialog">
<p class="qa-q"><strong>面试官</strong>：RAG 里用的 Embedding 算法有哪些？你了解过几代演进？</p>

<p class="qa-a"><strong>我</strong>：Embedding 算法我知道，Word2Vec 嘛，把词变成向量。</p>

<p class="qa-q"><strong>面试官</strong>：Word2Vec 是 2013 年的算法了，它每个词只有一个固定向量，「吃苹果」和「苹果手机」里的「苹果」向量完全一样，多义词都处理不了，你怎么拿它做语义检索？</p>

<p class="qa-a"><strong>我</strong>：那就用 BERT 呗，BERT 能理解上下文，效果肯定好。</p>

<p class="qa-q"><strong>面试官</strong>：BERT 做语义检索？你每次查询都要把问题和所有候选文档拼在一起跑一遍 BERT，百万级知识库跑百万次，你的用户等得起吗？SBERT 呢？SimCSE 呢？BGE 呢？这些专门为检索设计的 Embedding 模型你一个都没听说过？</p>
...
![](/images/cdn.xiaolincoding.com/picgo/1776785869934-53e4ada8-1048-4f8c-9e28-9382477d1344.png)

### 第一代：静态词向量（Word2Vec / GloVe / FastText）

先来看第一代算法。它们的核心思路非常朴素：用一个词周围的词来预测这个词，或者反过来用这个词来预测周围的词。通过大量文本训练，语义相近的词自然就会在向量空间里被推到一起。

![](/images/cdn.xiaolincoding.com/picgo/image-20260310180341826.png)
...
![](/images/cdn.xiaolincoding.com/picgo/1776785947203-e57e51f1-bfd9-4ad4-9fcf-027fda537272.png)
...
![](/images/cdn.xiaolincoding.com/picgo/1776785906281-75df6194-ebc4-494c-892f-4058bf16ca95.png)
...
![](/images/cdn.xiaolincoding.com/picgo/1776785977955-61600597-2b86-4656-a10c-ff00b75a886f.png)
...
![](/images/cdn.xiaolincoding.com/picgo/1776786056751-3aab642b-f729-4fc8-b06e-353d8feb9273.png)
