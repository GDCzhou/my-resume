...
description: "18. 大模型为什么会出现幻觉？怎么缓解？ 👔面试官：来讲讲大模型为什么会出现幻觉？怎么缓解？ 🙋‍♂️我：幻觉就是模型胡说八道嘛，主要是训练数据有错误，所以模型学错了。缓解办法是用 RAG 加上外部知识库。 👔面试官：……「训练数据有错误…"
---

# 18. 大模型为什么会出现幻觉？怎么缓解？

<div class="qa-dialog">
<p class="qa-q"><strong>面试官</strong>：来讲讲大模型为什么会出现幻觉？怎么缓解？</p>

<p class="qa-a"><strong>我</strong>：幻觉就是模型胡说八道嘛，主要是训练数据有错误，所以模型学错了。缓解办法是用 RAG 加上外部知识库。</p>

<p class="qa-q"><strong>面试官</strong>：……「训练数据有错误」？那如果训练数据 100% 正确，模型就不会幻觉了吗？再说，RAG 是工程方案，但你现在让我从「模型本身」角度讲幻觉的根因，不是让你讲 RAG 系统。</p>

<p class="qa-a"><strong>我</strong>：哦哦，那可能是模型的概率采样有随机性，所以会乱选词？</p>

<p class="qa-q"><strong>面试官</strong>：那把 Temperature 调到 0 是不是就不会幻觉了？为什么很多 LLM 在 Temperature=0 的时候也会一本正经地胡说八道？这个根因你能讲出来吗？</p>

<p class="qa-a"><strong>我</strong>：呃……不太清楚。</p>

<p class="qa-q"><strong>面试官</strong>：我再换个角度问你。同一个事实问题，比如「鲁迅是谁的笔名」，模型有时候答对、有时候答错。这两次答案对应模型概率分布的什么不同？模型对「自己不知道的事」内部有没有信号？为什么模型不会主动说「我不知道」？这些都搞清楚了，再来谈缓解方案。</p>
...
![](/images/cdn.xiaolincoding.com/picgo/hallucination_01_hallucination_example_e08763cd.png)
...
![](/images/cdn.xiaolincoding.com/picgo/hallucination_02_training_noise_15c72868.png)
...
![](/images/cdn.xiaolincoding.com/picgo/hallucination_03_llm_not_database_a966ffe5.png)
...
![](/images/cdn.xiaolincoding.com/picgo/hallucination_04_highest_probability_not_correct_a2b063ff.png)
...
![](/images/cdn.xiaolincoding.com/picgo/hallucination_05_parameterized_vs_retrieval_f76e6ea4.png)
...
![](/images/cdn.xiaolincoding.com/picgo/hallucination_06_rlhf_confidence_bec2e9ef.png)
...
![](/images/cdn.xiaolincoding.com/picgo/hallucination_07_hallucination_types_688c4d10.png)

理解了根因和分类，缓解方案就有了对症下药的落点。下面分三层来看。

![](/images/cdn.xiaolincoding.com/picgo/hallucination_08_three_layer_mitigation_1bf264e1.png)
...
![](/images/cdn.xiaolincoding.com/picgo/hallucination_09_training_layer_mitigation_de138918.png)
...
![](/images/cdn.xiaolincoding.com/picgo/hallucination_10_inference_layer_mitigation_57e49c6c.png)
...
![](/images/cdn.xiaolincoding.com/picgo/hallucination_11_rag_grounding_42364787.png)
...
![](/images/cdn.xiaolincoding.com/picgo/hallucination_12_reduce_not_eliminate_bf5f27fa.png)
