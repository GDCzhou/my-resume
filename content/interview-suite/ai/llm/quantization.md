...
description: "15. 大模型量化是什么？INT8/INT4/AWQ/GPTQ 怎么选？ 👔面试官：来讲讲什么是大模型量化？INT8、INT4、AWQ、GPTQ 这些方案怎么选？ 🙋‍♂️我：量化就是把模型参数从 32 位变成 8 位或 4 位，让模型变小…"
---

# 15. 大模型量化是什么？INT8/INT4/AWQ/GPTQ 怎么选？

<div class="qa-dialog">
<p class="qa-q"><strong>面试官</strong>：来讲讲什么是大模型量化？INT8、INT4、AWQ、GPTQ 这些方案怎么选？</p>

<p class="qa-a"><strong>我</strong>：量化就是把模型参数从 32 位变成 8 位或 4 位，让模型变小、跑得更快。AWQ、GPTQ 都是常见的量化方法。</p>

<p class="qa-q"><strong>面试官</strong>：……「变小变快」是表面现象。深一点说，量化的核心做了什么事？为什么 16 位的 FP16 可以直接降到 4 位的 INT4 而效果还能用？精度去哪了？</p>

<p class="qa-a"><strong>我</strong>：哦哦，应该是把数值范围映射到更少的离散值上吧？</p>

<p class="qa-q"><strong>面试官</strong>：对，但「怎么映射」就是量化方案的核心差别。AWQ 和 GPTQ 各自怎么映射？为什么一个叫「激活感知」一个叫「误差补偿」？再说，QLoRA 用的是哪种量化？为什么 INT4 量化后的模型还能微调？</p>

<p class="qa-a"><strong>我</strong>：呃……我用过 GGUF 文件，不知道里面是 AWQ 还是 GPTQ。</p>

<p class="qa-q"><strong>面试官</strong>：GGUF 是文件格式，不是量化算法。量化算法和文件格式是两层东西，混淆这两层就是没真正搞清楚。回去补一下。</p>
...
![](/images/cdn.xiaolincoding.com/picgo/quantization_01_effect_881e6404.png)
...
![](/images/cdn.xiaolincoding.com/picgo/quantization_02_flow_e1ea6bd5.png)
...
![](/images/cdn.xiaolincoding.com/picgo/quantization_03_comparison_342b7425.png)
...
![](/images/cdn.xiaolincoding.com/picgo/quantization_04_curve_48c2649c.png)
...
![](/images/cdn.xiaolincoding.com/picgo/quantization_05_flow_424d3ef5.png)
...
![](/images/cdn.xiaolincoding.com/picgo/quantization_06_analogy_54f5e8c2.png)
...
![](/images/cdn.xiaolincoding.com/picgo/quantization_07_comparison_e8d5a75f.png)
...
![](/images/cdn.xiaolincoding.com/picgo/quantization_08_architecture_73755a58.png)
...
![](/images/cdn.xiaolincoding.com/picgo/quantization_09_diagram_7f6a37c5.png)
...
![](/images/cdn.xiaolincoding.com/picgo/quantization_10_analogy_df1ec599.png)
...
![](/images/cdn.xiaolincoding.com/picgo/quantization_11_comparison_65ff6f64.png)
