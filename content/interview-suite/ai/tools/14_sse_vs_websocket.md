...
description: "14. 说说 WebSocket 和 SSE 通信的区别及局限性？ 👔面试官：说说 WebSocket 和 SSE 通信的区别及局限性？ 🙋‍♂️我：SSE 和 WebSocket 都是长连接，区别就是 SSE 比较简单，WebSocket…"
---

# 14. 说说 WebSocket 和 SSE 通信的区别及局限性？

<div class="qa-dialog">
<p class="qa-q"><strong>面试官</strong>：说说 WebSocket 和 SSE 通信的区别及局限性？</p>

<p class="qa-a"><strong>我</strong>：SSE 和 WebSocket 都是长连接，区别就是 SSE 比较简单，WebSocket 比较复杂。做 AI 对话的话，WebSocket 更好，因为它功能更强大，全双工嘛。</p>

<p class="qa-q"><strong>面试官</strong>：「功能更强大就更好」？那为什么 OpenAI、Anthropic 的流式 API 全都用 SSE 而不是 WebSocket？你得从实际场景出发去分析，不能只看功能强不强。</p>

<p class="qa-a"><strong>我</strong>：可能是因为 SSE 更简单吧？不过我觉得 SSE 就是 WebSocket 的简化版，功能上是 WebSocket 的子集，没什么本质区别。</p>

<p class="qa-q"><strong>面试官</strong>：这个理解不对。SSE 是 HTTP 协议的原生特性，WebSocket 是一个独立协议，两者底层机制完全不同。而且各自都有明确的局限性，SSE 有连接数限制、只支持文本传输；WebSocket 有状态、扩展难、容易被代理拦截。选型要看场景需求，不是简单的「谁是谁的子集」。</p>
...
![](/images/cdn.xiaolincoding.com/picgo/image-20260305150846903.png)
...
![](/images/cdn.xiaolincoding.com/picgo/931df16789fe81bed7f2058fb3f708e8.png)
...
![](/images/cdn.xiaolincoding.com/picgo/image-20260304194333734.png)

这条连接在技术上仍然是一个 HTTP 响应，只不过响应体是「无限长」的，服务端在不断往里追加内容，直到模型生成完毕才发送结束标志。可以把它理解为「一根从服务端流向客户端的单向水管」，水（数据）只能从服务端流向客户端，客户端没法往管子里倒水。

![](/images/cdn.xiaolincoding.com/picgo/cf20b66851b03090514e201877fd6788.png)
...
![](/images/cdn.xiaolincoding.com/picgo/image-20260304194005246.png)
...
![](/images/cdn.xiaolincoding.com/picgo/c58713d66fb6927716a2dc8cb49a6585.png)
...
![](/images/cdn.xiaolincoding.com/picgo/fb9df12374922b65a63d883e96a4fe0b.png)
...
![](/images/cdn.xiaolincoding.com/picgo/ee79d84cd35b9a6d74b813b7e7b1db73.png)
...
![](/images/cdn.xiaolincoding.com/picgo/6df48a1e06758ef3c366a45772a19ecf.png)
...
![](/images/cdn.xiaolincoding.com/picgo/4f14b036b9c7354d7be7089d70af98c4.png)
