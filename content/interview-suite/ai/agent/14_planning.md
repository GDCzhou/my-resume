...
description: "14. 如何赋予 LLM 规划能力？ 👔面试官：说说你是怎么给 LLM 加规划能力的？ 🙋‍♂️我：规划能力主要靠 CoT，就是在 prompt 里加一句「请一步步思考」，让 LLM 把推理过程写出来，就有规划能力了。 👔面试官：CoT 就…"
---

# 14. 如何赋予 LLM 规划能力？

<div class="qa-dialog">
<p class="qa-q"><strong>面试官</strong>：说说你是怎么给 LLM 加规划能力的？</p>

<p class="qa-a"><strong>我</strong>：规划能力主要靠 CoT，就是在 prompt 里加一句「请一步步思考」，让 LLM 把推理过程写出来，就有规划能力了。</p>

<p class="qa-q"><strong>面试官</strong>：CoT 就是规划能力的全部？你有没有想过 CoT 最大的问题是什么？</p>

<p class="qa-a"><strong>我</strong>：CoT 的问题……就是有时候推理链比较长，token 消耗多一些？</p>

<p class="qa-q"><strong>面试官</strong>：不对。CoT 是单条推理链，一旦一开始方向走错，后面全错，没有任何纠偏机制。ToT 就是为了解决这个问题才出来的，你知道 ToT 怎么做的吗？</p>

<p class="qa-a"><strong>我</strong>：ToT 是同时生成多条推理链，然后选最好的那个，类似于 beam search 的思路？</p>

<p class="qa-q"><strong>面试官</strong>：方向对，但不够准确。ToT 不是最后才选，而是边探索边评估边剪枝，是一个循环的过程。那 GoT 又比 ToT 多解决了什么问题，你说说看？</p>
...
![](/images/cdn.xiaolincoding.com/picgo/69bb980648f10fa386dc24636e792ea5.png)
...
![](/images/cdn.xiaolincoding.com/picgo/01_no_plan_vs_plan.png)
...
![](/images/cdn.xiaolincoding.com/picgo/image-20260305213047557.png)
...
![](/images/cdn.xiaolincoding.com/picgo/image-20260305213105782.png)

### ToT：从「一条链」到「一棵树」，解决走错方向的问题

ToT 的全称是 Tree of Thoughts（思维树），针对的正是 CoT「一旦走错就全错」的问题。

![](/images/cdn.xiaolincoding.com/picgo/image-20260305213615714.png)
...
![](/images/cdn.xiaolincoding.com/picgo/image-20260305213559790.png)
...
![](/images/cdn.xiaolincoding.com/picgo/02_tot_tree_search.png)

### GoT：从「树」到「图」，解决推理结果不能复用的问题

GoT 的全称是 Graph of Thoughts（思维图），是在 ToT 基础上再进一步的进化。

![](/images/cdn.xiaolincoding.com/picgo/image-20260305213142940.png)
...
![](/images/cdn.xiaolincoding.com/picgo/03_tot_vs_got.png)
...
![](/images/cdn.xiaolincoding.com/picgo/04_cot_tot_got_evolution.png)
...
![](/images/cdn.xiaolincoding.com/picgo/05_plan_and_execute_loop.png)
