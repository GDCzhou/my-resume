  ...
  return (
    <div className="no-print fixed right-4 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-2">
      ...
      <Link
        href="/interview"
        className="w-10 h-10 flex items-center justify-center bg-white rounded-lg shadow-md border border-gray-200 
                   hover:bg-purple-50 hover:border-purple-400 active:scale-95 transition-all duration-200 group"
        title="面试宝典"
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-500 group-hover:text-purple-600 transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
